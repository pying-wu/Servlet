...
/**
 * Servlet implementation class MyShowMessage
 */
@WebServlet(
		urlPatterns = { "/MyShowMessage" }, 
		initParams = { 
				@WebInitParam(name = "message", value = "Hello World"), 
				@WebInitParam(name = "repeats", value = "5")
		})

public class MyShowMessage extends HttpServlet {
